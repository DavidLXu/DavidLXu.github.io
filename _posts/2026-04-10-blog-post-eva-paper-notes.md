...
\\(\mathcal{L}\_{\text{IDM}} = \mathbb{E}\left[\sum_t \|f_\phi(I\_{t-k:t+k}) - a_t^{gt}\|_2^2\right]\\)
...
\\(P\_{\text{vel}} = \mathbb{E}\_t\|\max(|v_t| - v\_{\max}, 0)\|_2^2, \quad P\_{\text{acc}} = \mathbb{E}\_t\|\max(|\alpha_t| - a\_{\max}, 0)\|_2^2\\)
